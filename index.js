...
function sortHotelsByPricingLowToHigh(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortHotelsByPricingHighToLow(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'high-to-low') {
    sortedHotels.sort(sortHotelsByPricingHighToLow);
  } else {
    sortedHotels.sort(sortHotelsByPricingLowToHigh);
  }
...
function sortHotelsByReviewsLowToHigh(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

function sortHotelsByReviewsHighToLow(hotel1, hotel2) {
